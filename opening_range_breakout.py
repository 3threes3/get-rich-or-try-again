...
def place_opening_range_breakout_orders():
    ...
    if is_dst():
        start_minute_bar = f"{current_date} 16:30:00-00:00"
        end_minute_bar = f"{current_date} 16:45:00-00:00"
    else: 
        start_minute_bar = f"{current_date} 15:30:00-00:00"
        end_minute_bar = f"{current_date} 15:45:00-00:00"
